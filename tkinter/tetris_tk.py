...
Controls:
    ...
    space        Drop Tetronimoe to the bottom
    up arrow             Rotate anti-clockwise (to the left)
...
class game_controller(object):
    ...
    def __init__(self, parent):
        ...
        self.parent.bind("<Up>", self.rotate_callback)
        self.parent.bind("<Down>", self.down_callback)
        self.parent.bind("<space>", self.drop_callback)
